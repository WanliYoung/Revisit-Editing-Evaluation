...
class BaseEditor:
    ...
    def batch_edit(self,
        ...
        # evaluate pre edit model
        all_metrics = []
        for i, request in enumerate(tqdm(requests)):
            metrics = {"pre": compute_edit_quality(self.model, self.model_name, self.hparams, self.tok, request, self.hparams.device, test_generation=test_generation)}   
        ...
        # evaluate post edit model
        for i, request in enumerate(tqdm(requests)):  # for i, request in enumerate(requests):
            ...
            all_metrics[i]['post']['locality'].pop('neighborhood_output')
